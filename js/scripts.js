...
$formulario.addEventListener("submit", (e) => {  
    e.preventDefault();
    const {txtId, txtTitulo, txtTransaccion, txtDescripcion, txtPrecio, txtPuertas, txtKms, txtPotencia, txtPolarizado, txtCierre, txtAlarma} = $formulario;
    const formAnuncio = new Anuncio_Auto(parseInt(txtId.value), txtTitulo.value, txtTransaccion.value, txtDescripcion.value, txtPrecio.value, txtPuertas.value, txtKms.value, txtPotencia.value, txtPolarizado.checked,txtCierre.checked,txtAlarma.checked);
